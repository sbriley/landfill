...
write_table(survival_summary_table, "summary-table", "survival")
...
summary(glm( 
  Survival_index ~ EC_dS_m * Depth * Species,
...
write_table(enccal_chlorophyll_model$coefficients, "anova-enccal", "chlorophyll")

enccal_chlorophyll_model
